...
abstract class InactiveRelationResponse with _$InactiveRelationResponse {
  const factory InactiveRelationResponse({
    ...
    @JsonKey(name: 'last_wellness_at') required DateTime? lastWellnessAt,
    @JsonKey(name: 'inactive_days') required int inactiveDays,
  }) = _InactiveRelationResponse;

  factory InactiveRelationResponse.fromJson(Map<String, Object?> json) =>
      _$InactiveRelationResponseFromJson(json);
}
