...
class _RelationsService implements RelationsService {
  _RelationsService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<CareRelationResponse> createCareRelationApiV1RelationsPost({
    required CareRelationCreate body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<CareRelationResponse>(
    ...
    late CareRelationResponse _value;
    try {
      _value = CareRelationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<CareRelationResponse> updateCareRelationApiV1RelationsRelationIdPatch({
    required String relationId,
    required CareRelationUpdate body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
