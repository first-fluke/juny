...
class _MedicationsService implements MedicationsService {
  ...
  Future<MedicationResponse> createMedicationApiV1MedicationsPost({
    required MedicationCreate body,
  }) async {
  ...
  listMedicationsApiV1MedicationsGet({
    ...
    final _options = _setStreamType<PaginatedResponseMedicationResponse>(
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late PaginatedResponseMedicationResponse _value;
    try {
      _value = PaginatedResponseMedicationResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<MedicationResponse> updateMedicationApiV1MedicationsMedicationIdPatch({
    required String medicationId,
    required MedicationUpdate body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
