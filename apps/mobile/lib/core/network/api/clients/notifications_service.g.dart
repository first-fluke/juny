...
class _NotificationsService implements NotificationsService {
  ...
  listDeviceTokensApiV1NotificationsDeviceTokensGet() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<DeviceTokenResponse>>(
    ...
    late List<DeviceTokenResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                DeviceTokenResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
