...
## Purpose
providers Basic components of the system (auto-generated)

## Key Files
| File | Description |
|------|-------------|
| `medications_provider.g.dart` | Refer to feature details |
| `medications_provider.dart` | Refer to feature details |
